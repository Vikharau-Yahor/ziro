...
create table Ziro_ProjectDocument (Id UNIQUEIDENTIFIER not null, FileName NVARCHAR(100) not null, Description NVARCHAR(4000) not null, ContentType NVARCHAR(100) not null, Content VARBINARY(MAX) not null, UploadDate DATETIME2 not null, ProjectId UNIQUEIDENTIFIER not null, primary key (Id))
